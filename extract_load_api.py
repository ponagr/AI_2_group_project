...
def run_pipeline(query, table_name, occupation_fields):
    pipeline = dlt.pipeline(
        ...
        destination=dlt.destinations.duckdb("job_ads_data_warehouse.duckdb"),
...
if __name__ == "__main__":
    ...
    # Hotell, restaurang, storhushåll, "Installation, drift, underhåll", "Transport, distribution, lager"
